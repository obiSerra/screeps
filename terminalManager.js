...
const THRESHOLDS = {
  ...
  [RESOURCE_CATALYST]: { min: 5000, max: 20000 },
  [RESOURCE_GHODIUM]: { min: 2000, max: 10000 },
  [RESOURCE_POWER]: { min: 500, max: 5000 },
  
  // Compounds
  OH: { min: 2000, max: 10000 },
  UH: { min: 2000, max: 10000 },
  UO: { min: 2000, max: 10000 },
  KH: { min: 2000, max: 10000 },
  KO: { min: 2000, max: 10000 },
  LH: { min: 2000, max: 10000 },
  LO: { min: 2000, max: 10000 },
  ZH: { min: 2000, max: 10000 },
  ZO: { min: 2000, max: 10000 },
  GH: { min: 2000, max: 10000 },
  GO: { min: 2000, max: 10000 },
};

const CREDIT_RESERVE = 10000;  // Minimum credits to maintain
const MAX_ORDER_SIZE = 5000;    // Maximum units per order
const MIN_ORDER_VALUE = 100;    // Minimum credits for an order
